...
const testResult = [
    {
        ...
        "fields": {
            ...
            "音标": {
                "value": "[ɪnˈklaɪn] [sound:mdxldoce6-d1e69b97-6b58b15e-57522034-ee03c034-8d60021f.mp3]",
                "order": 1
            },
            "sentence": {
                "value": "",
            ...
            "背面": {
                "value": "v.（使）倾斜；（使）倾向于 [ˈɪnklaɪn] n. 斜坡，斜面（slope）<br>记　词根记忆：in（向内）＋clin（倾斜）＋e→向内斜→（使）倾斜<br>例　They have come back from their trip to Europe; they inclined to take a rest for a couple of days. 他们刚从欧洲旅行回来；这几天想休息一下。",
                "order": 3
            },
            "sound": {
                "value": "",
    ...
    },
    {
        ...
        "fields": {
            ...
            "音标": {
                "value": "[ˈkʌltɪveɪt] [sound:mdxldoce6-1aeb1dcd-2f594e76-cbc50bf6-786c616c-d830fb9e.mp3]",
                "order": 1
            },
            "sentence": {
                "value": "",
            ...
            "背面": {
                "value": "vt. 耕种；培养（bring up, foster）<br>记　词根记忆：cult（种植；培养）＋iv＋ate（动词后缀）→耕种；培养<br>例　Expressive leaders cultivate a personal relationship with staff in the group. 富有表现力的领导能与小组成员建立一种私人关系。<br>派　cultivation（n. 耕种；培养）",
                "order": 3
            },
            "sound": {
                "value": "",
...
describe('change the Notes fields', () => {
    function changeNotes(notes) {
        return notes.map(note => {
            ...
            const beimian = fields['背面'].value.split('<br>').filter(text => !text.includes('例　')).join('<br>')
            const sentence = fields['背面'].value.split('<br>').filter(text => text.includes('例　')).join('')
            return {
                id: noteId,
                fields: {
                    音标: yinbiao[0],
        ...
        expect(changeNotes(testResult)).to.deep.eq([
            {
                ...
                "fields": {
                    "音标": "[ɪnˈklaɪn]",
                    "sentence": "例　They have come back from their trip to Europe; they inclined to take a rest for a couple of days. 他们刚从欧洲旅行回来；这几天想休息一下。",
                    "背面": "v.（使）倾斜；（使）倾向于 [ˈɪnklaɪn] n. 斜坡，斜面（slope）<br>记　词根记忆：in（向内）＋clin（倾斜）＋e→向内斜→（使）倾斜",
                    "sound": "[sound:mdxldoce6-d1e69b97-6b58b15e-57522034-ee03c034-8d60021f.mp3]",
                },
            },
            {
                "id": 1489290687531,
                "fields": {
                    "音标": "[ˈkʌltɪveɪt]",
                    "sentence": "例　Expressive leaders cultivate a personal relationship with staff in the group. 富有表现力的领导能与小组成员建立一种私人关系。",
                    "背面": "vt. 耕种；培养（bring up, foster）<br>记　词根记忆：cult（种植；培养）＋iv＋ate（动词后缀）→耕种；培养<br>派　cultivation（n. 耕种；培养）",
                    "sound": "[sound:mdxldoce6-1aeb1dcd-2f594e76-cbc50bf6-786c616c-d830fb9e.mp3]",
                },
            },
        ])
